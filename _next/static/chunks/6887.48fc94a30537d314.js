...
`},86887:function(e,r,t){t.r(r),t.d(r,{FarcasterSignerStatusScreen:function(){return C},FarcasterSignerStatusView:function(){return f},default:function(){return C}});var i=t(57437),o=t(2265),n=t(97048),l=t(99379),a=t(57252),s=t(50640),c=t(87519),d=t(71716),h=t(72172),p=t(71554),u=t(4696),g=t(7612),x=t(48684);t(87336),t(67421),t(29155);let v="#8a63d2",f=({appName:e,loading:r,success:t,errorMessage:o,connectUri:l,onBack:h,onClose:p,onOpenFarcaster:u})=>(0,i.jsx)(g.S,n.tq||r?n.gn?{title:o?o.message:"Add a signer to Farcaster",subtitle:o?o.detail:`This will allow ${e} to add casts, likes, follows, and more on your behalf.`,icon:x.F,iconVariant:"loading",iconLoadingStatus:{success:t,fail:!!o},primaryCta:l&&u?{label:"Open Farcaster app",onClick:u}:void 0,onBack:h,onClose:p,watermark:!0}:{title:o?o.message:"Requesting signer from Farcaster",subtitle:o?o.detail:"This should only take a moment",icon:x.F,iconVariant:"loading",iconLoadingStatus:{success:t,fail:!!o},onBack:h,onClose:p,watermark:!0,children:l&&n.tq&&(0,i.jsx)(m,{children:(0,i.jsx)(c.O,{text:"Take me to Farcaster",url:l,color:v})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${e} to add casts, likes, follows, and more on your behalf.`,onBack:h,onClose:p,watermark:!0,children:(0,i.jsxs)(y,{children:[(0,i.jsx)(w,{children:l?(0,i.jsx)(d.Q,{url:l,size:275,squareLogoElement:x.F}):(0,i.jsx)(z,{children:(0,i.jsx)(s.L,{})})}),(0,i.jsxs)(b,{children:[(0,i.jsx)(j,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),l&&(0,i.jsx)(a.C,{text:l,itemName:"link",color:v})]})]})}),m=l.zo.div`
  margin-top: 24px;
`,y=l.zo.div`
  display: flex;
