...
`},87519:function(e,r,t){t.d(r,{O:function(){return a}});var i=t(57437),o=t(2265),n=t(99379);let a=e=>{let[r,t]=(0,o.useState)(!1);return(0,i.jsx)(l,{color:e.color,href:e.url,target:"_blank",rel:"noreferrer noopener",onClick:()=>{t(!0),setTimeout(()=>t(!1),1500)},justOpened:r,children:e.text})},l=n.zo.a`
  display: flex;
  align-items: center;
  gap: 6px;
