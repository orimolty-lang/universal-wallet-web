...
export const SellModal = ({
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed inset-x-0 bottom-0 z-50 bg-[#0d1b2a] rounded-t-3xl overflow-hidden flex flex-col max-h-[90vh] animate-slide-up" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
        {/* Header */}
